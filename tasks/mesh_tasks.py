...
def expand_seed(node_id: str, node_type: str, confidence: float = 0.85) -> dict[str, Any]:
    logger.info(
...
def rescore_cluster(cluster_id: str) -> dict[str, Any]:
...
def rescore_active_clusters_task(limit: int = 30) -> dict[str, Any]:
